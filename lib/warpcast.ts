...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    frame: {
      ...
      description: "Minting coins for the crew", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      primaryCategory: "social",
      tags: ["mini-app", "starter"], // up to 5 tags, filtering/search tags
      tagline: "Minting coins for the crew", // 30 characters, marketing tagline should be punchy and descriptive
      ogTitle: `${frameName}`, // 30 characters, app name + short tag, Title case, no emojis
      ogDescription: "Minting coins for the crew", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
