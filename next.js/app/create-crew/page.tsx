...
export default function CreateCrew() {
  ...
  useEffect(() => {
    if(wallet) {
      ...
      const updatedMembers = members.map((member, i) => {
        if (i === 0) {
          return { ...member, address: wallet.address as string, percentage: 50 };
        }
        if (i === 1) {
          return { ...member, percentage: 50 };
        }
        return member;
      });
  ...
  const validateMembers = async (members: Member[]) => {
    ...
    try {
      ...
      if (
        ...
        throw new Error("Invalid percentages, sum of percentages must be 100");
      }
  ...
  const handleCreateCrew = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log(
        `Crew saved in the DB: ${crewName} with splitAddress ${splitAddress}`,
      );
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  <div className="flex flex-col w-20">
                    <label className="text-sm text-gray-600 mb-1">Share %</label>
                    <input
                      type="number"
                      placeholder="%"
                      min="0"
                ...
                <div className="flex gap-2 mt-2">
                  <div className="flex flex-col flex-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateMembersByIndex(1, e.target.value, null)
                      }
                    />
                  </div>
                  <div className="flex flex-col w-20">
